...
- (void)locationManager:(CLLocationManager *)manager didEnterRegion:(CLRegion *)region
{
    ...
    [APPDELEGATE geoFenceEntryDetected:region];
    
    
    TEST_MODE_GEO_FENCE;
//    if ([[UIApplication sharedApplication] applicationState] == UIApplicationStateActive) {
//        UIAlertView *al=[[UIAlertView alloc]initWithTitle:@"geofence entry" message:region.identifier delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
//        [al show];
//    }
//    [self localNotificationForRegion:region.identifier andRegionEntry:YES];
    TEST_MODE_GEO_FENCE;
}
...
- (void)locationManager:(CLLocationManager *)manager didExitRegion:(CLRegion *)region
{
    ...
    [APPDELEGATE geoFenceExitDetected:region];
    
    
    
    TEST_MODE_GEO_FENCE;
//    if ([[UIApplication sharedApplication] applicationState] == UIApplicationStateActive) {
//        UIAlertView *al=[[UIAlertView alloc]initWithTitle:@"geofence exit" message:region.identifier delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
//        [al show];
//    }
//
//    [self localNotificationForRegion:region.identifier andRegionEntry:NO];
    TEST_MODE_GEO_FENCE;
    
    
    
}
-(void)localNotificationForRegion:(NSString*)identiifier andRegionEntry:(BOOL)flagEntered{
    ...
    if (flagEntered) {
        localNotification.alertBody = [NSString stringWithFormat:@"entered Region: %@", identiifier];
    }
    else{
        localNotification.alertBody = [NSString stringWithFormat:@"exit Region: %@", identiifier];
    }
